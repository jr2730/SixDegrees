...
//    }
    ...
    @Test
    public void testGetSearchForActorId() {
    	String ACTOR_NAME = "Harrison Ford" ;
    	String HARRISON_FORD_ID = "nm0000148" ;

        LOG.info("getSearch");
        // String result = imdbApi.getSearchForActorId("James Dean");
        String result = imdbApi.getSearchForActorId(ACTOR_NAME ) ;
        LOG.info("Result = " + result ) ;

        assertNotNull("Search is empty", result);
        assertTrue(result.equalsIgnoreCase(HARRISON_FORD_ID));
